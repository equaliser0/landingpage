...
<template>
  <div class="container mx-auto mt-24">
    <div class="">
      <h1 class="font-bold text-2xl pb-4">Dateien</h1>
    </div>
    <div class="overflow-x-auto bg-base-100 rounded rounded-xl p-8">
      <ul class="menu menu-xs bg-base-200 rounded-lg max-w-xs w-full">
        <li><a>
          ...
          resume.pdf
          <button class="btn btn-circle btn-sm bg-base-300 hover:bg-neutral">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 stroke-error fill-none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>
          </button>
        </a></li>
        <li>
          <details open>
